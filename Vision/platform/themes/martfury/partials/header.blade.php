            ...
            <div class="header__top">
                <div class="ps-container">
                    <div class="header__left">
                        ...
                        </div><a class="ps-logo" href="{{ route('public.index') }}"><img src="{{ RvMedia::getImageUrl(theme_option('logo')) }}" alt="{{ theme_option('site_title') }}" height="140px" width="200px"></a>
                    </div>
                        ...
                        @if (is_plugin_active('ecommerce'))
                            <ul class="navigation__extra">
                                @if (is_plugin_active('marketplace'))
                                    @if (!auth('customer')->check())
                                        <li><a href="{{ route('customer.login') }}">{{ __('Sell On ') }}</a></li>
                                    @else
